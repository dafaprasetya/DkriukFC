<header class="s-header">
    <div class="box">
        <nav role="navigation">
            ...
            <ul id="menu">
              ...
              <li><a href="#menuin">Menu</a></li>
              <li><a href="#pencapaian">Pencapaian</a></li>
              <li><a href="#kemitraan">Kemitraan</a></li>
              <li><a href="https://blog.dkriuk.com/">Artikel</a></li>
    ...
    <nav class="nav justify-content-center mt-3">
        ...
        <ul class="ul1" id="ul1">
            ...
            <a href="#tentang" class="smoothscroll">
                <li style="--i:#ff0000;--j:#ff0000">
            ...
            <a href="#menuin">
                ...
                <span class="judhul">Menu</span>
                </li>
            </a>
            <a href="#pencapaian" class="smoothscroll">
                <li style="--i:#ff0000;--j:#ff0000">
                    ...
                    <span class="judhul">Pencapaian</span>
                </li>
            </a>
            <a href="#kemitraan">
                <li style="--i:#ff0000;--j:#ff0000">
                    ...
                    <span class="judhul">Kemitraan</span>
                </li>
            </a>
            <a href="https://blog.dkriuk.com/">
                <li style="--i:#ff0000;--j:#ff0000">
                ...
                <span class="judhul">Artikel</span>
                </li>
            </a>
            <a href="#">
                <li style="--i:#ff0000;--j:#ff0000">
